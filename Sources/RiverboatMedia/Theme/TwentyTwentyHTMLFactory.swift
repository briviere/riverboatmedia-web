...
struct TwentyTwentyHTMLFactory: HTMLFactory {
    ...
    func makeIndexHTML(for index: Index, context: PublishingContext<RiverboatMedia>) throws -> HTML {
        HTML(
    ...
    func makeSectionHTML(for section: Section<RiverboatMedia>, context: PublishingContext<RiverboatMedia>) throws -> HTML {
        HTML(
    ...
    func makeItemHTML(for item: Item<RiverboatMedia>, context: PublishingContext<RiverboatMedia>) throws -> HTML {
        HTML(
    ...
    func makePageHTML(for page: Page, context: PublishingContext<RiverboatMedia>) throws -> HTML {
        HTML(
    ...
    func makeTagListHTML(for page: TagListPage, context: PublishingContext<RiverboatMedia>) throws -> HTML? {
        HTML(
            .websiteHead(for: page, on: context.site, stylesheetPaths: ["/styles.css?v=\(context.site.stylesVersion)"]),
            .body(
                .class("page-template"),
    ...
    func makeTagDetailsHTML(for page: TagDetailsPage, context: PublishingContext<RiverboatMedia>) throws -> HTML? {
        HTML(
            .websiteHead(for: page, on: context.site, stylesheetPaths: ["/styles.css?v=\(context.site.stylesVersion)"]),
            .body(
                .class("page-template"),
