...
extension Node where Context: HTML.BodyContext {
    ...
    static func navigationBar(for context: PublishingContext<RiverboatMedia>, selectedSection: RiverboatMedia.SectionID?) -> Node {
        let sectionIDs = RiverboatMedia.SectionID.allCases
